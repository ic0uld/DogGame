...
void FOnSteamCoreWebFailure_DelegateWrapper(const FMulticastScriptDelegate& OnSteamCoreWebFailure)
{
	...
	struct Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCoreWeb_Public_SteamCoreWeb_SteamCoreWebAsync_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCoreWeb_Public_SteamCoreWeb_SteamCoreWebAsync_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCoreWeb_Public_SteamCoreWeb_SteamCoreWebAsync_h_3783679501(TEXT("/Script/SteamCoreWeb"),
		Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCoreWeb_Public_SteamCoreWeb_SteamCoreWebAsync_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCoreWeb_Public_SteamCoreWeb_SteamCoreWebAsync_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
