...
void FOnGSClientDeny_DelegateWrapper(const FMulticastScriptDelegate& OnGSClientDeny, FGSClientDeny const& Data)
{
	...
	struct Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServer_SteamGameServerTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServer_SteamGameServerTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServer_SteamGameServerTypes_h_4171881646(TEXT("/Script/SteamCore"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServer_SteamGameServerTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServer_SteamGameServerTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
