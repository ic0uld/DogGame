...
void FOnControllerChangedCallback_DelegateWrapper(const FMulticastScriptDelegate& OnControllerChangedCallback, bool bIsConnected, int32 UserId)
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(SteamUtilities_eventGetBool_Parms, Settings), Z_Construct_UScriptStruct_FSteamSessionSetting, METADATA_PARAMS(nullptr, 0) }; // 3556044493
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(SteamUtilities_eventGetBool_Parms, Key), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_OutValue = { "OutValue", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(SteamUtilities_eventGetBool_Parms), &Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_OutValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(SteamUtilities_eventGetBool_Parms), &Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USteamUtilities_GetBool_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_Settings,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_Key,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_OutValue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_GetBool_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamUtilities_GetBool_Statics::Function_MetaDataParams[] = {
		{ "Category", "SteamCore|Utilities" },
		{ "Comment", "/*\n\x09* Function for getting a Bool attribute from session settings\n\x09* the function will return false if the string was not found or is not a bool\n\x09*/" },
		{ "ModuleRelativePath", "Public/SteamCore/SteamUtilities.h" },
		{ "ToolTip", "* Function for getting a Bool attribute from session settings\n* the function will return false if the string was not found or is not a bool" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USteamUtilities_GetBool_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USteamUtilities, nullptr, "GetBool", nullptr, nullptr, sizeof(Z_Construct_UFunction_USteamUtilities_GetBool_Statics::SteamUtilities_eventGetBool_Parms), Z_Construct_UFunction_USteamUtilities_GetBool_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_GetBool_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USteamUtilities_GetBool_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_GetBool_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USteamUtilities_GetBool()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_USteamUtilities_GetBool_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_bValue_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_bValue = { "bValue", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(SteamUtilities_eventMakeBool_Parms), &Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_bValue_SetBit, METADATA_PARAMS(Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_bValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_bValue_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(SteamUtilities_eventMakeBool_Parms, ReturnValue), Z_Construct_UScriptStruct_FSteamSessionSetting, METADATA_PARAMS(nullptr, 0) }; // 3556044493
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_bValue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::Function_MetaDataParams[] = {
		{ "Category", "SteamCore|Utilities" },
		{ "ModuleRelativePath", "Public/SteamCore/SteamUtilities.h" },
		{ "NativeMakeFunc", "" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USteamUtilities, nullptr, "MakeBool", nullptr, nullptr, sizeof(Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::SteamUtilities_eventMakeBool_Parms), Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USteamUtilities_MakeBool()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_USteamUtilities_MakeBool_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_bValue_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_bValue = { "bValue", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(SteamUtilities_eventMakeSearchBool_Parms), &Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_bValue_SetBit, METADATA_PARAMS(Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_bValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_bValue_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(SteamUtilities_eventMakeSearchBool_Parms, ReturnValue), Z_Construct_UScriptStruct_FSteamSessionSearchSetting, METADATA_PARAMS(nullptr, 0) }; // 2709255642
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_bValue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::Function_MetaDataParams[] = {
		{ "Category", "SteamCore|Utilities" },
		{ "ModuleRelativePath", "Public/SteamCore/SteamUtilities.h" },
		{ "NativeMakeFunc", "" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USteamUtilities, nullptr, "MakeSearchBool", nullptr, nullptr, sizeof(Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::SteamUtilities_eventMakeSearchBool_Parms), Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USteamUtilities_MakeSearchBool()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_USteamUtilities_MakeSearchBool_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USteamUtilities_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USteamUtilities_GetBool, "GetBool" }, // 332634362
		...
		{ &Z_Construct_UFunction_USteamUtilities_GetType, "GetType" }, // 341480416
		...
		{ &Z_Construct_UFunction_USteamUtilities_MakeBool, "MakeBool" }, // 1138769972
		...
		{ &Z_Construct_UFunction_USteamUtilities_MakeSearchBool, "MakeSearchBool" }, // 1494715167
	...
	struct Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_USteamUtilities, USteamUtilities::StaticClass, TEXT("USteamUtilities"), &Z_Registration_Info_UClass_USteamUtilities, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamUtilities), 2846225458U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_3196719429(TEXT("/Script/SteamCore"),
		Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SourcTree_DogsClub_Plugins_SteamCore_Source_SteamCore_Public_SteamCore_SteamUtilities_h_Statics::EnumInfo));
