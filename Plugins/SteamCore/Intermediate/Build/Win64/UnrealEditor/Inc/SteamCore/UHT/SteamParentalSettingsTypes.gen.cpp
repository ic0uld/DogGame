...
template<> STEAMCORE_API UScriptStruct* StaticStruct<FSteamParentalSettingsChanged>()
{
	...
	struct Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_2555213168(TEXT("/Script/SteamCore"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamParentalSettings_SteamParentalSettingsTypes_h_Statics::EnumInfo));
