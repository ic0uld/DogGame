...
void FOnScreenshotRequested_DelegateWrapper(const FMulticastScriptDelegate& OnScreenshotRequested, FScreenshotRequested const& Data)
{
	...
	struct Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_3641541533(TEXT("/Script/SteamCore"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::EnumInfo));
