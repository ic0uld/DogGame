...
void FOnFileDetailsResultDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnFileDetailsResultDelegate, FFileDetailsResult const& Data)
{
	...
	struct Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamApps_SteamAppsTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamApps_SteamAppsTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamApps_SteamAppsTypes_h_2965200684(TEXT("/Script/SteamCore"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamApps_SteamAppsTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Montee_SourceTree_Plugins_SteamCore_Source_SteamCore_Public_SteamApps_SteamAppsTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
