...
void FOnGSStatsUnloaded_DelegateWrapper(const FMulticastScriptDelegate& OnGSStatsUnloaded, FGSStatsUnloaded const& Data)
{
	...
	struct Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServerStats_SteamGameServerStatsTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServerStats_SteamGameServerStatsTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServerStats_SteamGameServerStatsTypes_h_40911449(TEXT("/Script/SteamCore"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServerStats_SteamGameServerStatsTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Commando_Hero_Klasoru_CommandoHero_Plugins_SteamCore_Source_SteamCore_Public_SteamGameServerStats_SteamGameServerStatsTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
